...
<div class="container">
  <header>
    <a href="index.php"><img src="../a2/images/silverado(1).png" id="logo" alt="Silverado Cinemas"/></a>
  </header>
  <nav>
    <ul>
      ...
      <li id="cart"><a href="cart.php">(0)<img src="../a2/images/cart(1).png" alt="Shopping Cart"/></a>
    </ul>
  </nav>
